...
<body>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Myself chandrashekar i was working as a devops engineer since last 3years. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
